    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        datePickerCalculateDays();" x-model = "datePickerValue" x-cloak>
            <div class="container px-4 py-2 mx-auto md:py-10">
                <div class="w-64 mb-5">
                    <label for="datepicker" class="block mb-1 text-sm font-medium text-neutral-500">Filter Date</label>
            ...
            <tbody>
                ...
                @foreach ($todos as $todo)
                    <tr>
                        ...
                        <td scope="row" class="px-6 py-4 font-medium text-red-500 whitespace-nowrap dark:text-white">
