<div>
    ...
    <form wire:submit.prevent='store'>
        <div class="grid gap-3 py-[100px] mb-3 md:grid-cols-2">
            <div class="flex flex-col">
                <div class="flex items-center flex-1">
                    ...
                    <div class="z-50 flex items-center mt-5 " x-data="{
                ...
                <button type="submit"
                    class="text-white flex-3 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-[590px] px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
            </div>
    </form>
    <script>
