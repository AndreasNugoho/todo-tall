<div>
    ...
    <form wire:submit.prevent='store'>
        <div class="grid gap-3 py-[50px]">
            <div class="flex flex-col items-center flex-wrap">
                <div class="w-8/12 lg:w-3/12 mx-auto flex flex-col items-center">
                    <div class="flex flex-wrap justify-center items-center w-full">
                        <div class="flex flex-col items-center w-full">
                            <label for="first_name" class="block mb-1 text-sm font-medium text-neutral-500">Add Task</label>
                            <input type="text" id="first_name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                wire:model='title' required placeholder="Ketikkan task.."/>
                        </div>

                        <div class="z-50 flex items-center mt-5 w-full" x-data="{
                        ...
                        datePickerCalculateDays();" x-cloak>
                            {{-- <input type="hidden" wire:model='datePickerValue'> --}}
                            <div class="container w-full mx-auto">
                                <div class="w-full mb-5">
                                    <label for="datepicker" class="block mb-1 text-sm font-medium text-neutral-500">Select
                                        Date</label>
                                    <div class="relative">
                                        <input x-ref="datePickerInput" type="text"
                                            ...
                                            placeholder="Select date" readonly x-model="datePickerValue" />
                                                ...
                                                <template x-for="(day, dayIndex) in datePickerDaysInMonth"
                                                    ...
                                                    <div class="px-0.5 mb-1 aspect-square">
                                                        <div x-text="day" @click="datePickerDayClicked(day)"
                                                            ...
                                                            wire:click.prevent="selectDate(day,datePickerMonthNames[datePickerMonth], datePickerYear)">
                                                        </div>
                                                    </div>
                                                </template>
                                            </div>
                    ...
                    <button type="submit"
                        class="text-white flex-3 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                </div>
            </div>
    </form>
    <script>
